                        ...
                        <form action="{{ route('admin.products.store') }}" method="POST" role="form">
                            ...
                            <div class="tile-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label" for="special_price">Prix ​​special</label>
                                            <input
                            ...
                            <div class="tile-footer">
                                <div class="row d-print-none mt-2">
                                    <div class="col-12 text-right">
                                        ...
                                        <a class="btn btn-danger" href="{{ route('admin.products.index') }}"><i class="fa fa-fw fa-lg fa-arrow-left"></i>Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </form>
