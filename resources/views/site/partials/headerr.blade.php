...
<nav class="fixed-top navbar-expand-lg navbar-light bg-lignt py-3 fon-white border-bottom shadow" style="background: #f8f8f8;">
    <div class="">
        <div class="navbar-brand d-flex col-12">
            ...
            <div class = "col-4 text-center authed">
                <a href="{{ route('home') }}">
                    <img class="logo" src="/frontend/img/logo-brown.png" alt="logo">
            ...
            @else
                <div class = "col-4 d-flex justify-content-end authed">
                  <span class="nav-item dropdown">
                    ...
                    <span class="nav-item">
                      <a href="{{route('checkout.cart') }}" class="text-black nav-link" >
        ...
        <div class="collapse navbar-collapse justify-content-center mt-3 mb-2" style = "font-family: cursive;" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown" >
                    <a class="nav-link dropdown-toggle text-capitalize text-black" id="category" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Collections</a>
                ...
                <li class="nav-item dropdown" >
                    <a class="nav-link dropdown-toggle text-capitalize text-black" id="category" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Jewelry</a>
                    <ul class="dropdown-menu" id="dropdown-menu">
                        <li class="nav-item" id="catName2" >
                ...
                {{--            new in--}}
                <li class="nav-item">
                    <a class="nav-link text-capitalize text-black" href="/">New In</a>
                </li>
                {{--           Best sellers--}}
                <li class="nav-item">
                    <a class="nav-link text-capitalize text-black" href="/">Best sellers</a>
                </li>
                {{--            contact us--}}
                <li class="nav-item">
                    <a class="nav-link text-capitalize text-black" href="{{route('contact') }}">About us</a>
                </li>
            </ul>
        </div>
    </div>
